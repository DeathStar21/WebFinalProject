...
if(isset($_POST['order_btn'])){
   ...
   $cart_query = mysqli_query($conn, "SELECT * FROM `cart` WHERE user_id = '$admin_id'");
   ...
   $detail_query = mysqli_query($conn, "INSERT INTO `order`(firstname,phone,email,method,addressno, street, city, pin_code, total_products, total_price) VALUES('$firstname','$phone','$email','$method','$flat','$street','$city','$pin_code','$total_product','$price_total')") or die('query failed');
...
<section class="checkout-form">
   ...
   <div class="display-order">
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            <span>city</span>
            <input type="text" placeholder="bkk" name="city" required>
         </div>   
         <div class="inputBox">
            <span>pin code</span>
